...
class FaceDetect:
    ...
    def face_enhance(self,img):
        res_main = FaceEnhanceGFPGAN()
        res_main = res_main.enhance(img)
        return res_main

    def arcane_face(self,img):
        res_main = Arcane()
        res_main = res_main.image(img)
        return res_main
    ...
    def detect(self,img):
        ...
        bg_img = self.arcange_bg(img_raw)
