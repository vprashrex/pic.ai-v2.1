...
/opt/venv/bin/gunicorn -k uvicorn.workers.UvicornWorker --workers 5 --worker-connections 1000 --worker-class gevent  src.app:app --bind "0.0.0.0:${APP_PORT}" --timeout 10000
